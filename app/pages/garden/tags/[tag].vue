...
<template>
    <div class="max-w-3xl mx-auto">
        ...
        <div class="mb-8 border-b border-soft pb-4 flex items-center gap-3">
            ...
            <span class="px-3 py-1 bg-hover rounded-full text-sm text-muted">
        ...
        <div class="grid gap-3">
            ...
            <div v-if="!notes?.length" class="text-center py-16 border-2 border-dashed border-soft rounded-2xl">
